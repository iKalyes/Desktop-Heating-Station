...
def HeatingON(event_struct):
    return


def HeatingOFF(event_struct):
    return


def KPUp(event_struct):
    return


def KIDown(event_struct):
    return


def KIUp(event_struct):
    return


def KDDown(event_struct):
    return


def KDUp(event_struct):
    return
